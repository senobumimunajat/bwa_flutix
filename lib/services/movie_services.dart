...
class MovieServices {
  ...
  static Future<MovieDetail> getDetails(modelsUser.Movie movie,
    ...
    return movieID != null
        ? modelsUser.MovieDetail(modelsUser.Movie.fromJson(data),
            language: language,
            genres: genres
                .map((e) => (e as Map<String, dynamic>)['name'].toString())
                .toList())
        : modelsUser.MovieDetail(movie,
            language: language,
            genres: genres
                .map((e) => (e as Map<String, dynamic>)['name'].toString())
                .toList());
  ...
  static Future<List<modelsUser.Credit>> getCredits(int movieID,
